...
Pushes to `main` on `alocare-ai/alocare-app-web` auto-deploy via Vercel Git integration. Add the custom domain `app.alocare.net` in Vercel (CNAME → `cname.vercel-dns.com`). See [docs/DEPLOYMENT.md](docs/DEPLOYMENT.md).
